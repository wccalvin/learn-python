...
class InstanceCounter(object):
    ...
    def __init__(self, num1):
        ...
        # Yes, we can call class attribute inside the method as shown.
...
print "Class Data   : %s" % inst_1.count
# This eventually changes to 5 because the count is incremented as new
# instances are created.
inst_2 = InstanceCounter(4)
print "Class Data   : %s" % inst_2.count
# This eventually changes to 5 because the count is incremented as new
# instances are created.
inst_3 = InstanceCounter(6)
print "Class Data   : %s" % inst_3.count
# This eventually changes to 5 because the count is incremented as new
# instances are created.
inst_4 = InstanceCounter(8)
print "Class Data   : %s" % inst_4.count
# This eventually changes to 5 because the count is incremented as new
# instances are created.
inst_5 = InstanceCounter(10)
print "Class Data   : %s" % inst_5.count
# This eventually changes to 5 because the count is incremented as new
# instances are created.

print "Class Data of inst_1: %s" % inst_1.count
# This eventually changes to 5 because the count is incremented as new
# instances are created.
print "Instance Data: %s" % inst_3.value

format.example("-", 2, 7)
(inst_1.given, inst_2.given, inst_3.given, inst_4.given, inst_5.given) = (15,
                                                                          30,
                                                                          45,
                                                                          60,
                                                                          75)
