...
2. Encapsulation refers to the safe storage of data (attributes) in an instance
    ...
    b. Data should be validated as correct depending on the prerequisites of
       the class.
    c. Data should be safe from changes by external process.
3. Summary: Setting the value in the object with the use of the setter method
   shown below is called Encapsulation.
"""
...
# Changing the value of second instance from outside the class or in the main
# body of the code
